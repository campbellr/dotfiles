...
export PATH=.env/bin:$HOME/bin:$HOME/.local/bin/:/bin/:/sbin/:/usr/bin:/usr/local/bin:/home/runner/bin/:/spgear/tools/bin/:/usr/local/go/bin
...
hash -p /spgear/tools/bin/git git
...
[ -n "$PS1" ] && source $VIRTUALENVWRAPPER_SCRIPT
